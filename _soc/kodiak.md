...
status-audio-spdif:
status-camera: 6.14
status-camera-comment: DT bits pending for 6.16
status-camera-csi: 6.14
status-camera-datapath: 6.14
status-camera-eva: N
status-camera-i2c: 6.7
status-camera-sfe: 6.14
status-camera-vfe: 6.14
status-camera-vfelight: 6.14
